...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_gsv__MainWindow4Server_t, stringdata0) + ofs), len 
...
const QMetaObject gsv::MainWindow4Server::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_gsv__MainWindow4Server.offsetsAndSize,
