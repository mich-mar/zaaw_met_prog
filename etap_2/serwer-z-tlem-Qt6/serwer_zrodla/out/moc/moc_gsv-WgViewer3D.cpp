...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_gsv__WgViewer3D_t, stringdata0) + ofs), len 
...
const QMetaObject gsv::WgViewer3D::staticMetaObject = { {
    QMetaObject::SuperData::link<QGLViewer::staticMetaObject>(),
    qt_meta_stringdata_gsv__WgViewer3D.offsetsAndSize,
